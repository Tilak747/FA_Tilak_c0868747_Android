package c0868747.tilak.finaltestandroid.di;
...
import c0868747.tilak.finaltestandroid.db.MyDB;
...
public class DbModule {
    ...
    MyDB provideDB(@ApplicationContext Context context) {
        return Room.databaseBuilder(context, MyDB.class, "AndroidFinalTestDB")
